...
public class DateChooserJButton extends JButton {  
    ...
    public DateChooserJButton(String preLabel, Date date) {  
        ...
        super.addActionListener(new ActionListener() {  
            ...
            { 												///////// 
                if (dateChooser == null) {  
                    dateChooser = new DateChooser(); 		//进入日历的地方
    ...
    {
    	return new SimpleDateFormat("yyyy-MM-dd");  //不使用小时
        ...
        private JPanel createButtonBarPanel() {  
            ...
            ok.addActionListener(new ActionListener() {  
                ...
                public void actionPerformed(ActionEvent e) {  
                    ...
                    //System.out.println( getTextOfDateChooserButton() );	//修改的地方
                    //隐藏日历对话框  									//////////////
...
//    	JFrame myframe = new JFrame("me");
//    	DateChooserJButton mybutton = new DateChooserJButton();
//    	panel.add( mybutton );
//    	mybutton.setBounds(50, 50, 200, 60);
//    	
//    	myframe.add(panel);
